    ...
    specialSystems: [
      {
        ...
        description: enEs(
          "Rituals are learned and cast separately from the dot powers. Each ritual has its own level and casting requirements.",
          "Los rituales se aprenden y se lanzan aparte de los poderes principales. Cada ritual tiene su propio nivel y requisitos de invocación.",
        ),
        needsReview: true,
        items: [],
      },
    ...
    specialSystems: [
      {
        ...
        description: enEs(
          "Classic Thaumaturgy splits into focused paths of related effects, learned in dot order like sub-disciplines of their own.",
          "La Taumaturgia clásica se divide en sendas enfocadas de efectos afines, aprendidas por niveles como subdisciplinas en sí mismas.",
        ),
        needsReview: true,
        items: [],
      },
      {
        ...
        title: enEs("Rituals", "Rituales"),
        description: enEs(
          "Thaumaturgy rituals follow their own learning rules outside the path structure. Each ritual is its own contained working.",
          "Los rituales de Taumaturgia siguen sus propias reglas de aprendizaje, ajenas a la estructura de las sendas. Cada ritual es un acto cerrado en sí mismo.",
        ),
        needsReview: true,
        items: [],
      },
    ...
    specialSystems: [
      {
        ...
        title: enEs("Paths", "Sendas"),
        description: enEs(
          "Classic Necromancy organizes into death-themed paths, learned in dot order like focused sub-disciplines.",
          "La Nigromancia clásica se organiza en sendas con temática de muerte, aprendidas por niveles como subdisciplinas enfocadas.",
        ),
        needsReview: true,
        items: [],
      },
      {
        ...
        title: enEs("Rituals", "Rituales"),
        description: enEs(
          "Necromancy rituals are independent of the paths and follow their own learning rules.",
          "Los rituales de Nigromancia son independientes de las sendas y siguen sus propias reglas de aprendizaje.",
        ),
        needsReview: true,
        items: [],
      },
    ...
    specialSystems: [
      {
        ...
        description: enEs(
          "Oblivion ceremonies are death-touched rites learned and performed separately from the dot powers. Each ceremony has its own dot rating.",
          "Las ceremonias de Olvido son ritos tocados por la muerte que se aprenden y ejecutan aparte de los poderes principales. Cada ceremonia tiene su propio nivel.",
        ),
        needsReview: true,
        items: [],
      },
    ...
    specialSystems: [
      {
        ...
        description: enEs(
          "Thin-Blood Alchemy is built from formulae brewed by the alchemist rather than flat dot powers. Each formula has its own level and is learned individually.",
          "La Alquimia de Sangre Débil se construye a partir de fórmulas que el propio alquimista prepara, en lugar de poderes principales. Cada fórmula tiene su propio nivel y se aprende de forma individual.",
        ),
        needsReview: true,
        items: [],
      },
