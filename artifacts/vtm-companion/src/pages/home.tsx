...
export default function Home() {
  ...
  const modules = [
    { title: "Clanes", desc: "Arquetipos, debilidades y disciplinas", icon: Users, href: "/clanes", color: "text-blue-400" },
    { title: "Disciplinas", desc: "Poderes de la sangre", icon: Droplet, href: "/disciplinas", color: "text-red-500" },
    { title: "Reglas", desc: "Mecánicas, Hambre y Combate", icon: Book, href: "/reglas", color: "text-amber-400" },
    { title: "Herramientas", desc: "Dados, rastreador de hambre", icon: Wrench, href: "/herramientas", color: "text-emerald-400" },
  ];
